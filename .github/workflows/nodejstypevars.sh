...
if [ -z "${CI_OSTYPE}" ]; then
	...
	INSTALL_PKG_LIST="git gcc g++ make procps ca-certificates gnupg libyaml-dev k2hdkc-dev chmpx-dev k2hash-dev libssl-dev"
	...
	INSTALL_AUTO_ARG="-y"
	INSTALL_QUIET_ARG="-q"
	INSTALL_PKG_LIST="git gcc gcc-c++ make procps xz libyaml-devel k2hdkc-devel chmpx-devel k2hash-devel openssl-devel"
	NODEJS_PKG_LIST="nodejs"
	...
	INSTALL_AUTO_ARG="-y"
	INSTALL_QUIET_ARG="-q"
	INSTALL_PKG_LIST="git gcc gcc-c++ make procps xz libyaml-devel k2hdkc-devel chmpx-devel k2hash-devel nss-devel"
	NODEJS_PKG_LIST="nodejs"
